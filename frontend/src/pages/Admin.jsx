...
const Admin = () => {
    // Gerencia o estado da página, incluindo a lista de documentos, filtros e seleção.
    ...
    // Gerencia o estado da ordenação e paginação.
    ...
    const fetchDocumentos = useCallback(async (token, isNewSearch) => {
        ...
        try {
            ...
            // Atualiza os tokens de paginação com base nos resultados.
            if (isNewSearch) {
    ...
    // Seleciona ou deseleciona todos os documentos visíveis na página.
    ...
    // Apaga os documentos que foram selecionados na tabela.
    const handleDeleteSelected = async () => {
        ...
        if (window.confirm(`Tem certeza que deseja apagar ${docsParaApagar.length} arquivo(s)?`)) {
            ...
            try {
                ...
                // Atualiza a lista de documentos na tela após a exclusão.
    ...
    // Funções para navegar entre as páginas de resultados.
    ...
    return (
        <div className="flex flex-col min-h-screen bg-black text-white p-4 pb-24 md:pb-4">
            ...
            <main className="w-full max-w-6xl mx-auto pt-24 md:pt-28">
                ...
                {/* Barra de ferramentas com busca, filtro e botão de apagar. */}
                ...
                {/* Tabela para exibir a lista de documentos. */}
                <div className="bg-gray-800 rounded-lg border border-gray-700 overflow-x-auto">
                    <table className="min-w-full divide-y divide-gray-700">
                        ...
                        <tbody className="bg-gray-800 divide-y divide-gray-700">
                            {/* Renderiza o estado de carregamento, "nenhum resultado" ou as linhas da tabela. */}
                            {carregando ? (
                ...
                {/* Botões de paginação para navegar entre os resultados. */}
